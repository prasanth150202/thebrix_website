 ...
 * homepage: one destination, hit five times, and nothing else to click.
 * The nav links, the burger and the whole footer are gone ($page_chrome),
 * so the only way off the page is the App Store listing the campaign is
 * paying to reach.
 *
