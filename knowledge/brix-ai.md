# Brix AI (the in-app assistant)

Available on every plan, credit-limited.

Brix AI is a chat assistant embedded throughout the BRIX admin app (look for the "Ask Brix"
bar). Merchants can ask it to:

- Write titles, descriptions, and upsell copy for their cart, bundles, and product pages.
- Set up a new upsell rule by describing it in plain language ("recommend our travel case
  whenever someone buys a passport holder").
- Create a Shopify discount code by describing the offer ("10% off code SUMMER10 that
  expires in two weeks").
- Configure a rewards progress bar by describing the tiers they want.
...
1. Open the "Ask Brix" bar from any page in the app.
